...
git clone https://github.com/wadiehabib/vendor_xiaomi_davinci.git -b 12 vendor/xiaomi/davinci --depth=1
git clone https://github.com/wadiehabib/kernel_xiaomi_davinci.git -b 12 kernel/xiaomi/davinci --depth=1
git clone https://github.com/wadiehabib/kernel_xiaomi_davinci.git -b kernel-headers kernel/xiaomi/davinci-headers
git clone https://github.com/wadiehabib/vendor_xiaomi_davinci.git -b extra vendor/xiaomi/davinci-extra --depth=1
